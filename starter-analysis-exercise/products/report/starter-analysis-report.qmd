...
csl: ../apa.csl
---
EMMA HARDIN-PARKER contributed to this exercise.
...
@fig-result2 shows a box plot giving the distributions of "Height" and "Hair Color" made from R. Black haired 
individuals tend to average about 173 cm. with a max of 180 cm. and a low of 162. Brown haired individuals average about 166 cm. with a max of 176 and low of 154. Red haired individuals average about 166 cm. with a max of 171 and low of 151. There is no distribution for purple and white due to there being only one individual for each.

```{r}
#| label: fig-result2
#| fig-cap: "A box plot of Height (cm) and Hair Color."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","height-color-box.png"))
```

@fig-result3 shows a scatter plot showing the correlation between "Weight" and "Strands of Hair" made from R.
It turns out that there is no correlation between these two variables.

```{r}
#| label: fig-result3
#| fig-cap: "A scatter plot showing Weight (lbs) and Strands of Hair."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","weight-strands-scatter.png"))
```
...
Example @tbl-resulttable3 shows a silly linear model fit of "Hair Color" and "Strands of Hair" as predictors for "Height". The small sample size makes drawing any accurate conclusions difficult.

```{r}
#| label: tbl-resulttable3
#| tbl-cap: "Linear model fit table of Hair Color and Strands of Hair as predictors for Height."
#| echo: FALSE
