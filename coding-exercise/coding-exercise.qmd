...
#Loading dslabs dataset "murders"
#probably a more morbid data set but interesting to observe nonetheless
library(dslabs)
help(murders)
str(murders)
summary(murders)
...
#From a quick view of the plot, we see that there appears to be a postive correlation that there are more gun murders
#in states with higher populations
#lets run a linear model to see if the data gives a statistically significant observation
